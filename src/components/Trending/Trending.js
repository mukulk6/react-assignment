...
{(question.tags).length!=null && <h3>Tags:<span className={styles.tagLabel}>{question.tags}</span></h3>}
</div>
</div>

<div class="row">
<div class="col-md-12">
{question.answersList && question.answersList.map((answer)=>{return(
...
{answer.expertFirstName}&nbsp;{answer.expertLastName}
</span>
